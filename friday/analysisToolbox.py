...
print('#####################################')
print('DIAS Toolbox for DATA signal analysis')
print('#####################################')
print('Available options:')
print('\t 1. Analyze DATA folder to check for missing files.')
print('\t 2. Create maps for injection and node distribution.')
print('\t 3. Perform signal analysis on DAT files to check for bad DAT files.')
choice = int(input('What shall you choose, traveler? '))
# # INPUTS
# LINE/GRID ROOT FOLDER
dataRoot = 'C:\\Users\\HugoLarnier\\Documents\\projects\\orano\\data\\SD0\\'
dataRoot = 'C:\\Users\\HugoLarnier\\Documents\\projects\\mmg_mcArthur\\L37\\'
