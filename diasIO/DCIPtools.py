...
class JvoltDipole:
    ...
    def getDipoleStack(self, stack_dir):
        ...
        # bin_file = "C:\\Projects\\FieldSchool\\FS2017\\Stack\\P1_R2_HK_HO.stk"
    ...
    def getZplotpoint(self, Idp):
        r = np.sqrt((Idp.Tx1x - self.Rx2x)**2 +
         (Idp.Tx1y - self.Rx2y)**2 + (Idp.Tx1Elev - self.Rx2Elev)**2)
